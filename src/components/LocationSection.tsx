              ...
              <div className="space-y-12 relative z-10">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <a href="tel:+212522255555" className="flex items-center gap-3 text-text-muted hover:text-white transition-colors group/link">
                      <Phone size={14} className="group-hover/link:text-gold transition-colors" />
                      <span className="text-sm">+212 522 255 555</span>
                    </a>
